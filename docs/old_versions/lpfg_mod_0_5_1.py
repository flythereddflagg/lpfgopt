...
# to be added:
# args                       - Check!
# imports specified          - Check!
# numpy additions            - Check!
# private functions          - Check!
# implimentation in python 3
# integer optimizer
# numerical additions
...
def lfsolve(f,x0=None,intervals=None,args=(),full_output=False,
    ...
    if x0 == None and intervals == None: 
        ...
        if s_step == None:  # if no spread step is specified estimate one based
            s_step = f_obj(x0,*args) * 0.1 # on the current value of the objective
                                     # function
        spread = 0.0
...
def _main():
    """Some driver code to test the algorithm."""
